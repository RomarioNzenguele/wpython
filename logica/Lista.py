...
paises.extend(["Niger", "Zimbabwe", "Cabo Verde"]) # extend add mais do que um item
...
print("\nRetornando o maior ano:", max(listas[1])) # retornando o maior ano. Usar min para o inverso
